...
| 参数    | 类型   |  默认值  |  必填  |  说明 |
| :----: | :-----:  | :----:  |  :--: |  :---: |
| type   | String |   image  |  是  |  文件类型， 这里为背景图，默认image |
| url    |   String   |  ''  |  是   |  网络图片地址  |
...
| shape  | String  | 'square'  | 否  |   绘制图片的形状, square 方形， circle 圆形  |
...
| textAlign  | String  | 'center'  |  否  |  文本水平对齐方式, 可选left, center, right  |
...
### 后续
欢迎大佬们来拍砖，有问题欢迎提issue，感觉好用的欢迎star哦~
